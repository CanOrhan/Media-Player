...
class Extensions  extends XML
{
    ...
    public void parseExtensions(XmlPullParser xpp) throws XmlPullParserException, IOException
    {
    ...
    static public  Extensions parse(XmlPullParser xpp) throws XmlPullParserException, IOException
    {
        Extensions Extensions = new Extensions();
        Extensions.parseExtensions(xpp);
        return Extensions;
    }
